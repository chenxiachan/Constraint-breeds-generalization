...
| Static input features are transformed into temporal trajectories via **Attractor System** ($\delta$). | Intrinsic dissipation is controlled via the **SNN Membrane Leak** ($\beta$). |
|*Exp 1-3* | *Exp 3* |
